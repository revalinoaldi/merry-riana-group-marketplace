                        ...
                        <div class="billing-fields">
                            <div class="fields-content">
                                <div class="field-row">
                                    ...
                                    <input type="hidden" name="total" value="{{ $qty*$produk->harga }}">
                                    <input type="hidden" name="subtotal" value="{{ $produk->harga }}">
                ...
                <div class="col-md-6">
                    <div class="cart-totals style2">
                        ...
                        <table class="product">
                            ...
                            <tbody>
                                <tr>
                                    <td>{{ $produk->nama_produk }} <br>(Qty : {{ $qty }})</td>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <td>Sub Total</td>
                                    <td class="subtotal">Rp. {{ number_format(($produk->harga*$qty), 0, ',','.') }}</td>
                                </tr>
                                <tr>
                                    <td>Grand Total</td>
                                    <td class="price-total">Rp. {{ number_format(($produk->harga*$qty), 0, ',','.') }}</td>
                                </tr>
                            </tbody>
                        </table>
                        <div class="checkbox">
